    ...
    try {
      ...
      if (result?.error) {
        if (result.error === 'Invalid credentials') {
          ...
          setError('This account is not registered as a property owner');
        } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-20 h-20 bg-purple-400/20 rounded-full opacity-40 animate-pulse" />
        <div className="absolute bottom-20 right-10 w-24 h-24 bg-blue-400/20 rounded-full opacity-40 animate-pulse delay-1000" />
        <div className="absolute top-1/3 right-20 w-16 h-16 bg-indigo-400/20 rounded-full opacity-40 animate-pulse delay-500" />
      </div>
      ...
      <div className="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          ...
          <div className="mt-6 text-center">
            ...
            >
              Are you a tenant? <span className="underline">Sign in here</span>
            </Link>
          </div>
        </div>
      </div>
